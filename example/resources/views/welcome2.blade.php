...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-lg-9">
            ...
            <a href="#" class="small mr-3"><span class="icon-envelope mr-2"></span> <span class="d-none d-lg-inline-block">smaku@mydomain.com</span></a> 
          </div>
    ...
    <div class="sticky-nav js-sticky-header">
      <div class="container position-relative">
        <div class="site-navigation text-center">
          <a href="index.html" class="logo menu-absolute m-0">SMAKU<span class="text-primary">.</span></a>    
  ...
  <div class="untree_co-hero overlay" style="background-image: url('images/welcome.jpg');">
        ...
        <div class="col-12">
          ...
          <div class="row justify-content-center ">
            ...
            <div class="col-lg-6 text-center ">
              ...
              <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Kesuksesan membutuhkan usaha yang keras dan pendidikan yang berkualitas</h1>
    ...
    <script src="{{ url('js/popper.min.j') }}s"></script>
